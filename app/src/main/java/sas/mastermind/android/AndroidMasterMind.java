...
public class AndroidMasterMind {
    private final Logic logic = new LogicImplementation(new SessionDAO());//Falta implementar el DAO
    private final View view = new sas.mastermind.android.views.View();
